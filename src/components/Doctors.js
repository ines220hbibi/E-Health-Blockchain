			...
			<div className="row doctors_row">
				...
				<div className="col-xl-3 col-md-6">
					<div className="doctor">
						...
						<div className="doctor_content">
							<div className="doctor_name"><a href="#">Christian Williams</a></div>
							<div className="doctor_title">Surgeon</div>
							<div className="doctor_link"><a href="#">+</a></div>
						</div>
					</div>
				...
				<div className="col-xl-3 col-md-6">
					<div className="doctor">
						...
						<div className="doctor_content">
							<div className="doctor_name"><a href="#">Jessica Walsh</a></div>
							<div className="doctor_title">Surgeon</div>
							<div className="doctor_link"><a href="#">+</a></div>
						</div>
					</div>
				...
				<div className="col-xl-3 col-md-6">
					<div className="doctor">
						...
						<div className="doctor_content">
							<div className="doctor_name"><a href="#">Martha James</a></div>
							<div className="doctor_title">Surgeon</div>
							<div className="doctor_link"><a href="#">+</a></div>
						</div>
					</div>
				...
				<div className="col-xl-3 col-md-6">
					<div className="doctor">
						...
						<div className="doctor_content">
							<div className="doctor_name"><a href="#">Christina Smith</a></div>
